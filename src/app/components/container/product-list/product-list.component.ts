...
export class ProductListComponent implements OnInit {
  ...
  totalProductCount = this.products.length;//prodcts count
  totalProductInStock = this.products.filter(product => product.is_in_inventory).length;//returns true
  totalProductOutOfStock = this.products.filter(product => !product.is_in_inventory).length;//returns false

  // @ouput event cmng from filter comp
